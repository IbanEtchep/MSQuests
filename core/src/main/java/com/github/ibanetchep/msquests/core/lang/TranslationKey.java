...
public enum TranslationKey implements Translatable {
    ...
    QUEST_ADMIN_ROTATED("quest_admin.quest.rotated"),
    QUEST_COMMAND_ROTATED("quest.command.rotated"),
    ...
    ZMENU_QUEST_STATUS_AVAILABLE("zmenu.quest.status.available"),
    ZMENU_QUEST_PROGRESS_COMPLETED("zmenu.quest.progress.completed"),
